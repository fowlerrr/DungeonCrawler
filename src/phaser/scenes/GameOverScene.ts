...
/** Shown on player death - the current level restarts (new seed, same level number) once the
 * player continues; equipment carries over since GameScene's Inventory is untouched. */
